...
extension CoordinatorPresentable {
    ...
    func presentCoordinator(_ childCoordinator: BaseCoordinatorPresentable, animated: Bool, presentation: UIModalPresentationStyle = .overFullScreen) {
        childCoordinator._rootViewController.modalPresentationStyle = presentation
